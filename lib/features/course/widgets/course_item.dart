...
class CourseItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 96,
      decoration: BoxDecoration(color: Pallete.offWhiteColor, borderRadius: BorderRadius.circular(14)),
      child: Row(
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration:
                        BoxDecoration(color: Pallete.onPurpleBackground, borderRadius: BorderRadius.circular(4)),
                    child: Text(
                      '$totalHours hours',
                      style: const TextStyle(
